...
const team = [
    { name: "Mohammed Al-Harbi", role: "Founder & CEO", description: "A Makkah native with 15+ years in the transport industry. Mohammed founded the company with a vision to provide reliable transport for pilgrims." },
    { name: "Omar Abdullah", role: "Operations Manager", description: "Oversees daily operations, fleet management, and driver coordination. Ensures every ride meets our quality standards." },
    { name: "Aisha Siddiqui", role: "Customer Relations", description: "Heads our multilingual customer support team. Available 24/7 to ensure every customer has a positive experience." },
];
