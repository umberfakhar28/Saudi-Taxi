            ...
            <section className="section-lg" style={{ paddingBottom: 0 }}>
                <div className="container">
                    <p style={{ color: 'var(--text-body)', lineHeight: 1.8, maxWidth: '760px' }}>
                        Booking for a specific city? Our <Link href="/services/makkah" style={{ color: 'var(--accent)', fontWeight: 600 }}>Makkah taxi service</Link> and <Link href="/services/madinah" style={{ color: 'var(--accent)', fontWeight: 600 }}>Madinah taxi service</Link> pages cover the local pickup points and Ziyarat stops in more detail than a package overview can.
                    </p>
            ...
            <section style={{ background: 'linear-gradient(135deg, var(--primary-dark) 0%, var(--primary) 100%)', padding: '5rem 0', textAlign: 'center' }}>
                <div className="container">
                    ...
                    <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
                        ...
                        <a href={WHATSAPP_URL} className="btn btn-outline btn-lg" target="_blank" rel="noopener noreferrer">💬 WhatsApp Us</a>
                    </div>
                </div>
            </section>
        </main>
