...
export default function Post() {
  return <BlogPost data={{ title: "Hajj 2025 Transportation Guide", category: "Religious Travel", date: "June 2025", excerpt: "The five days of Hajj require precise transport planning. Here's what you need to know.", body: [
