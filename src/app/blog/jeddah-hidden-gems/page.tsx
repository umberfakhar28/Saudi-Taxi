...
export default function Post() {
  return <BlogPost data={{ title: "Hidden Gems in Jeddah Most Tourists Miss", category: "Destinations", date: "June 2025", excerpt: "Al-Balad is magnificent, but Jeddah's real character lives in its lesser-known corners.", body: [
